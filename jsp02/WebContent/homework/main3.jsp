...
action="${path}/session_servlet/login.do">
	...
	<button id="login-btn" type="submit" class="fadeIn first" value="LOGIN" border="0">로그인</button>
</form>
<div>
	<input type="button" value="아이디찾기" onclick="findid()">
	<input type="button" value="비밀번호찾기" onclick="findpass()">
	</div>
    <!-- Remind Passowrd -->
    <div id="formFooter ">
 	  <a class="underlineHover" href="../homework/join2.jsp" style="display: inline-block; margin-top:20px;">아직도 회원이 아닌가요? 가입신청!</a><br>
    </div>
	<div id="formCopy">
	ⓒ 2020 화개장터
	</div>
